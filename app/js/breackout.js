function breackout() {
	...
	var y = canvas.height / 2 - ballRadius; //begining coordinates
	...
	function getRandomColor() {
		...
		//		}
		//		return color;
		let colorsArray = ['red', 'lightgreen', 'yellow', 'pink']
		return colorsArray[Math.floor(Math.random() * 4)];
	}
	...
	function reset() {
		...
		y = canvas.height / 2 - ballRadius; //begining coordinates
